...
//those functions are for choose suit devices //
...
void HelloTriangleApplication::createLogicalDevice() {
    ...
    createInfo.queueCreateInfoCount = static_cast<uint32_t>(queueCreateInfos.size()); static_cast<uint32_t>(queueCreateInfos.size());
...
void HelloTriangleApplication::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex, VkRenderPass &renderPass,
...
void HelloTriangleApplication::drawFrame() {
    ...
    recordCommandBuffer(commandBuffers[currentFrame], imageIndex, pipeline.renderPass, framebuffer.swapChainFramebuffers, pipeline.graphicsPipeline);
...
void HelloTriangleApplication::cleanupSwapChain() {
        for (size_t i = 0; i < framebuffer.swapChainFramebuffers.size(); i++) {
            vkDestroyFramebuffer(device, framebuffer.swapChainFramebuffers[i], nullptr);
        }
...
void HelloTriangleApplication::recreateSwapChain() {
    ...
    createSwapChain();
    createImageViews();
    framebuffer.createFramebuffers(device, swapChainImageViews, swapChainExtent, pipeline.renderPass);
}
...
void HelloTriangleApplication::createDecriptorSetLayout() {
...
void HelloTriangleApplication::createUnifromBuffer() {
...
void HelloTriangleApplication::initVulkan() {
    ...
    pipeline.createGraphicsPipeline(device, swapChainExtent, descriptorSetLayout);
    framebuffer.createFramebuffers(device, swapChainImageViews, swapChainExtent, pipeline.renderPass);
    createCommandPool();
    createVertexBuffer();
    createIndexBuffer();
